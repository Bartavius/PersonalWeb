  ...
  return (
    <div className="my-card blur-gradient d-inline-block border-accent1 card-container d-flex flex-column">
      ...
      <div className="my-card-footer d-flex justify-content-end mt-auto">
        {websiteLink && <a href={websiteLink} target="_blank" rel="noreferrer"><button className="button-secondary">Website</button></a>}
        {githubLink && <a href={githubLink} target="_blank" rel="noreferrer"><button className="button-secondary ms-3">Github</button></a>}
      </div>
    </div>
  );
}
